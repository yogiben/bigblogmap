...
function updateExperienceButton(value){

$('#interaction').removeClass('false visited wants');

$('#interaction').addClass(value);

}


function updateOpinionButton1(){
$('.interaction-opinion-btn').removeClass('active');
$('.interaction-opinion-1').addClass('active');
}

function updateOpinionButton2(){
$('.interaction-opinion-btn').removeClass('active');
$('.interaction-opinion-2').addClass('active');
}

function updateOpinionButton3(){
$('.interaction-opinion-btn').removeClass('active');
$('.interaction-opinion-3').addClass('active');
}
...
$(".btn-false").click(function() {
	updateExperienceButton('false');
});

$(".btn-visited").click(function() {
	updateExperienceButton('visited');
});

$(".btn-wants").click(function() {
	updateExperienceButton('wants');
});



$(".interaction-opinion-1").click(function() {
	updateOpinionButton1();
});

$(".interaction-opinion-2").click(function() {
	updateOpinionButton2();
});

$(".interaction-opinion-3").click(function() {
	updateOpinionButton3();
});
